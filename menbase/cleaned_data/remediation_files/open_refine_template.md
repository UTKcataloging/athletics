# Open Refine Template University of Tennessee Volunteers Baseball``
...
{{if(isBlank(cells['title_cover'].value), '', '<titleInfo type="alternative"><title>' + cells["title_cover"].value + '</title></titleInfo>')}}
