# Open Refine Template Athletic Programs - Basketball Server Backlog
...
<form authority="aat" valueURI="{{cells['form2_URI'].value}}">{{cells['form2'].value}}</form>
...
{{if(isBlank(cells['subject_topic_4'].value), '', '<subject><topic>' + cells['subject_topic_4'].value + '</topic></subject>')}}
...
{{if(isBlank(cells['subject_name_2'].value), '', '<subject' + if(isBlank(cells['subject_name_2_URI'].value), '', ' authority="wikidata" valueURI="' + cells['subject_name_2_URI'].value + '"') + '><name><namePart>' + cells['subject_name_2'].value + '</namePart></name></subject>')}}
...
{{if(isBlank(cells['subject_name_4'].value), '', '<subject' + if(isBlank(cells['subject_name_4_URI'].value), '', ' authority="' + cells['subject_name_4_auth'].value + '" valueURI="' + cells['subject_name_4_URI'].value + '"') + '><name><namePart>' + cells['subject_name_4'].value + '</namePart></name></subject>')}}
{{if(isBlank(cells['subject_name_5'].value), '', '<subject authority="wikidata" valueURI="' + cells['subject_name_5_URI'].value + '"><name><namePart>' + cells['subject_name_5'].value + '</namePart></name></subject>')}}
{{if(isBlank(cells['subject_name_6'].value), '', '<subject authority="wikidata" valueURI="' + cells['subject_name_6_URI'].value + '"><name><namePart>' + cells['subject_name_6'].value + '</namePart></name></subject>')}}

<subject authority="naf" valueURI="{{cells['subject_geographic_URI'].value}}"><geographic>{{cells['subject_geographic'].value}}</geographic><cartographics><coordinates>35.96064, -83.92074</coordinates></cartographics></subject>
