# Open Refine Template University of Tennessee Lady Volunteers Track and Field
...
{{if(isBlank(cells['subject_name_4'].value), '', '<subject authority="wikidata" valueURI="' + cells['subject_name_4_URI'].value + '"><name><namePart>' + cells['subject_name_4'].value + '</namePart></name></subject>')}}
...
<relatedItem displayLabel="Project" type="host"><titleInfo><title>University of Tennessee Lady Volunteers Track and Field Media Guides</title></titleInfo></relatedItem>
